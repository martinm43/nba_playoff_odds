...
def get_wins(team_id):
    ...
    away_query = BS.select().where(BS.season_year == 2019, BS.away_team_id == team_id, BS.away_pts > 0)
    ...
    home_query = BS.select().where(BS.season_year == 2019, BS.home_team_id == team_id, BS.home_pts > 0)
    ...
    return {'away_wins_total':away_wins_total,'away_games_total':away_games_total,'home_wins_total':home_wins_total,'home_games_total':home_games_total}
