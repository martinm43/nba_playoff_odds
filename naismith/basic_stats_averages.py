...
#print "This is a script for obtaining four factors data for teams and their opponents"
...
for i in range(1,31):
  ...
  str_input='SELECT CASE WHEN away_standard_id='+team_id+\
           ' THEN away_pts-home_pts, away_reb, away_fg_pct, away_fg3_pct, away_ft_pct, away_tov WHEN home_standard_id='+team_id+\
           ' THEN home_pts-away_pts, home_reb, home_fg_pct, home_fg3_pct, home_ft_pct, home_tov END FROM nba_py_api_data WHERE\
...
#csvfile_out = open(wkdir+'adj_pts_diff_vector.csv','wb')
